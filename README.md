...
|---|---|---|
| Vibra general | ¿Qué sensación debería transmitir esta consola cuando uno la ve, la sostiene o la usa? | Se debe sentir como un **Game Boy modernizado**: simple, reconocible, portable y nostálgico, pero con una sensación más premium, más capaz y más personalizable. No debe sentirse como una mini PC metida en una carcasa, sino como una consola con identidad propia. |
| Idea insignia | ¿Cuál es la idea loca o distintiva que haría que esta consola no sea simplemente “otra handheld”? | **¿Qué pasaría si el Game Boy fuera teletransportado a la modernidad?** La consola debe combinar feel retro con performance y versatilidad modernas. Debe parecer una evolución directa de las consolas que homenajea, no una imitación barata ni un gadget genérico. |
| Fantasía de uso | ¿Cómo me imagino usando esta consola en el mejor escenario posible? | Debe vivir entre dos mundos: uso casual “on the move” y uso más cómodo en casa. Debe poder sacarse rápidamente en una fila, en una sala de espera o en un trayecto corto, pero también sostener sesiones más largas en viajes, escritorio o sofá. Idealmente debe tener una transición tipo Switch entre portabilidad y uso en casa, aunque en V0 esto pueda ser más conceptual que completamente resuelto. |
| Ritual de uso | ¿Hay algo especial en prenderla, cargar juegos, cambiar modos, usar accesorios o personalizarla? | Debe tener rituales propios: boot screen, loading screens, sonidos, home visual, perfiles o modos. La idea de cartridges modernos es central: no necesariamente un cartucho con un solo juego, sino un módulo físico que pueda representar una colección, una categoría, un modo, un perfil, una estética o una experiencia. El ritual debe reforzar que esto es una consola, no simplemente Linux abriendo un emulador. |
| Relación con lo retro | ¿Quiero que se sienta nostálgica, moderna, experimental, industrial, premium, juguetona o una mezcla? | Debe tener un feel **retro plus**: nostálgica, directa, física y sencilla, pero sin heredar innecesariamente las malas limitaciones de las consolas antiguas. Puede homenajear los parlantes modestos, los botones físicos, los cartuchos, el arranque dedicado y la simplicidad de interfaz, pero no debe justificar una pantalla mala, mal rendimiento o una experiencia incómoda bajo la excusa de “lo retro”. |
| Sistema físico especial | ¿Hay alguna idea física distintiva: cartridges, módulos, docking, tapas, bisagra, grips, piezas intercambiables? | Los cartridges son la idea física insignia. También se deben explorar: docking, tapa para pantalla, módulos reemplazables, controles modificables, almacenamiento expandible, carcasa reparable y posibilidades de upgrade. El form factor base debe inspirarse en la familiaridad de un Game Boy, pero con mejoras de calidad de vida modernas: mejor ergonomía, controles más cómodos y layout personalizado según estándares de memoria muscular/visual modernos (íconos de los botones). |
| Sistema digital especial | ¿Hay alguna idea de software distintiva: perfiles, colecciones, modos, temas, lanzadores, categorías, saves, achievements? | El sistema debe arrancar en una experiencia tipo consola: home claro, visualmente cuidado, navegable con controles, con acceso rápido a juegos, sistemas, favoritos y ajustes. Si hay un sistema operativo tipo PC debajo, debe quedar escondido o relegado a un modo técnico. La experiencia por defecto no debe ser “prender un computador y abrir un programa”, sino “prender una consola”. Debe poder usarse con teclado/mouse cuando sea necesario para mantenimiento, configuración o cambios técnicos. |
| Personalización | ¿Qué debería poder modificar el usuario: juegos, controles, temas, carcasas, módulos, botones, almacenamiento? | La consola debe ser altamente personalizable con suficiente esfuerzo: botones, joysticks, almacenamiento, carcasa, temas visuales, boot screens, layouts, módulos físicos y formas de input/output. Debe favorecer estándares abiertos o comunes del mundo DIY: USB, Bluetooth, microSD, HDMI, audio externo y componentes reemplazables. La personalización no tiene que estar toda lista en V0, pero la arquitectura no debería bloquearla desde el inicio. |
| Restricción creativa | ¿Qué limitación quiero abrazar como parte de la identidad del proyecto? | ¿Qué limitación quiero abrazar como parte de la identidad del proyecto? Las limitaciones deben ser mejorables para el usuario que lo quiera. Por ejemplo, en principio parlantes cheap como tenían las de inspiración (Igual los SFX de estos juegos suenan mejor y más auténticos en parlantes mediocres como los de la época), pero debe haber forma de mejorar el sonido por lo menos conectándose a algo externo. Lo mismo para los controles y la imagen. Ojo, las restricciones creativas deben intentar no ser un cop-out para bajar la calidad de los componentes (e.g. no usar una pantalla mediocre, que quita feel premium, excusado en que así son las consolas retro). |
| Línea roja conceptual | ¿Qué cosa no quiero que esta consola sea, aunque técnicamente sea más fácil? | No puede ser no portátil. No puede rendir peor que una R36S de referencia. No puede sentirse excesivamente DIY, frágil, improvisada o como un computador genérico. No puede requerir demasiado setup para jugar. No puede sacrificar la experiencia de consola por facilidad técnica. |
| Idea para explorar después | ¿Qué idea no pertenece a esta versión, pero debería quedar guardada para V1, V2 u otra consola? | Cartridges como perfiles físicos, cartridges como almacenamiento, cartridges como llaves de modo, dock de sobremesa, módulos de controles, tapa/protector de pantalla y estuche, sistema de temas, sonidos propios, edición de boot screens, carcasa intercambiable, módulo de audio mejorado, módulo de batería extendida y modos de uso “casa / viaje / rápido”, en específico con Power Plan default correspondiente. |
| Decisión | Pregunta guía | Significado |
| Nombre del proyecto | ¿Cómo se llama esta consola dentro de Handheld Lab? | Aunque use hardware genérico o Linux, la experiencia debe sentirse dedicada, cerrada y lista para jugar. |
| Versión actual | ¿Qué versión estoy desarrollando en este chat? | La nostalgia debe aparecer en los rituales, el formato y la simplicidad, no en baja calidad de pantalla, controles malos o bajo rendimiento. |
| Tipo de consola | ¿Es retro, moderna, doble pantalla, experimental, modular, plegable u otra cosa? | Lo físico y lo digital deben permitir exploración del usuario/comunidad: almacenamiento, controles, temas, pantallas externas, audio externo, dock y futuros módulos. |
| Inspiración principal | ¿Qué consola, producto o idea inspira este proyecto? | Definición |
| Objetivo principal | ¿Qué quiero lograr con esta versión? | Handheld Zero |
| Criterio de éxito | ¿Cómo sé que esta versión cumplió su propósito? | V0 |
| Criterio de fracaso | ¿Qué tendría que pasar para considerar que esta versión no logró su objetivo? | Retro experimental |
| Decisión | Pregunta guía | R36S |
| Juegos objetivo | ¿Hasta qué sistemas, generaciones o tipos de juego quiero correr de forma razonable? | Entender el pipeline de desarrollo de una handheld retro: componentes, costos, proveedores, compatibilidad técnica, ensamblaje, software y riesgos reales. |
| Nivel mínimo de performance | ¿Cuál es el rendimiento mínimo aceptable para que el proyecto valga la pena? | Tener un prototipo funcional, aunque no sea todavía práctico ni estéticamente final, que demuestre que la arquitectura escogida puede convertirse en una consola portable real. |
| Plataforma principal | ¿Qué placa, SoC, mini PC, arquitectura o sistema base podría usar? | Respuesta inicial |
| Sistema operativo | ¿Qué software, distribución, frontend o entorno usaré? | Retro ligero: 8-bit, 16-bit, GBC/GBA y, si es viable, 5ta generación. |
| Pantalla | ¿Qué tamaño, resolución, relación de aspecto y tipo de pantalla tendría sentido? | Pendiente de plataforma específica. Se evaluarán plataformas reales comprables y desarrollables, priorizando SBC compacto o compute module con carrier board comercial. No se escogerá chipset en abstracto ni se empezará con carrier board propia en V0. |
| Controles | ¿Qué botones, joysticks, D-pad, gatillos y distribución necesita? | Pendiente según plataforma. Debe soportar experiencia tipo consola, pick-up-and-play, boot razonable, save/load automático o mitigaciones equivalentes. |
| Audio | ¿Necesita parlantes, jack 3.5 mm, Bluetooth o una solución mínima? | Pendiente. |
| Conectividad | ¿Necesita Wi-Fi, Bluetooth, USB-C, HDMI, microSD u otros puertos? | Pendiente. |
| Almacenamiento | ¿Dónde vivirán el sistema, los juegos, saves, configuraciones y posibles “cartridges”? | Pendiente. |
| Compatibilidad | ¿Qué componentes o estándares conviene usar para evitar depender de piezas raras? | Pendiente. |
| Decisión | Pregunta guía | Respuesta inicial |
| Tipo de batería | ¿LiPo plana, 18650, powerbank interna, batería comercial u otra solución? | Pendiente por diseño de carcasa (V1). |
| Capacidad objetivo | ¿Cuántas horas reales de uso quiero lograr? | Trip largo, alrededor de 6 horas, negociable con modulo extra. |
| Carga | ¿Cómo se carga: USB-C, módulo dedicado, PD, cargador externo, carga balanceada? | Pendiente por diseño. |
| Protección eléctrica | ¿Cómo evito sobrecarga, sobredescarga, cortos, inversión de polaridad o daño de componentes? | Pendiente por diseño. |
| Consumo estimado | ¿Cuánta corriente consume el sistema en reposo, jugando y en carga máxima? | Pendiente por diseño. |
| Gestión térmica | ¿El sistema necesita disipador, ventilación, ventilador o solo control pasivo? | Respuesta inicial |
| Seguridad de prototipo | ¿Qué condiciones mínimas debo cumplir antes de meter batería dentro de una carcasa cerrada? | Vertical, una pantalla, controles no touch, tipo GB. |
| Decisión | Pregunta guía | Bolsillo/maleta. |
| Formato | ¿Será horizontal, vertical, plegable, tipo tablet, tipo clamshell, modular u otro? | Cómodo a dos manos. |
| Tamaño objetivo | ¿Debe ser de bolsillo, mochila, escritorio o simplemente transportable? | Impresa 3D. |
| Ergonomía | ¿Cómo debería sentirse al sostenerla durante 30-60 minutos? | Buscar evitar ensamble destructivo (pegante). |
| Distribución interna | ¿Dónde irían placa, batería, pantalla, controles, parlantes, puertos y cables? | Pendiente por diseño. |
| Carcasa | ¿Será impresa en 3D, modificada de otra consola, acrílico, CNC, madera, kit o híbrida? | Respuesta inicial |
| Ensamble | ¿Cómo se cierra y se abre: tornillos, inserts, clips, imanes, módulos? | Cautín, multímetro, impresora 3D, herramientas lab IELE. |
| Reparabilidad | ¿Qué tan fácil debe ser abrirla, cambiar piezas y diagnosticar fallas? | 1. Diseño correcto de PCBs. |
| Acabado | ¿Qué nivel de terminación busco en esta versión: prototipo crudo, funcional limpio o apariencia de producto? | 1. Pantalla 2. Cerebro / SBC simple con chipset escogido. Módulo compute. |
| Tolerancias físicas | ¿Qué piezas requieren precisión especial: botones, pantalla, puertos, bisagras, tapas, cartridges? | Pendiente por diseño. |
| Decisión | Pregunta guía | Pendiente por diseño. |
| Herramientas disponibles | ¿Qué tengo: cautín, multímetro, impresora 3D, fuente, osciloscopio, estación de aire, etc.? | Respuesta inicial |
| Herramientas faltantes | ¿Qué herramienta podría bloquear el proyecto si no la consigo? | 500.000 COP entre diseño y BOM. |
| Habilidades a aprender | ¿Qué necesito aprender para completar esta versión? | Sin techo. |
| Piezas compradas | ¿Qué componentes compraré listos para reducir complejidad? | Chipset. |
| Piezas diseñadas | ¿Qué partes diseñaré yo mismo? | Idealmente todo. |
| Piezas modificadas | ¿Qué partes comerciales puedo adaptar o hackear? | Mercados online, zonas de electrónicos en Bogotá. |
| Riesgos de fabricación | ¿Qué parte es más probable que falle por precisión, fragilidad, calor, cableado o diseño? | Resultado esperado |
| Estrategia de prototipado | ¿Qué debo probar primero antes de comprometerme con una carcasa o compra grande? | Sistema corriendo fuera de una carcasa final, con pantalla, controles, audio y energía resueltos al menos de forma básica. |
| Decisión | Pregunta guía | Consola cerrada, usable y con carcasa funcional. |
| Presupuesto máximo | ¿Cuánto puedo gastar en esta versión completa? | Mejor ergonomía, autonomía, distribución interna y acabado. |
| Presupuesto de error | ¿Cuánto puedo perder razonablemente si algo sale mal? | Diseño más limpio, modular, reparable y potencialmente replicable. |
| Componentes críticos | ¿Qué piezas definen el éxito técnico del proyecto? | Por qué desbloquea el proyecto |
| Componentes reutilizables | ¿Qué puedo reutilizar en otra versión si esta falla o cambia de rumbo? | Define chipset, formato, OS, consumo, tamaño, conectividad y posibilidades futuras. |
| Componentes baratos para prueba | ¿Qué puedo comprar barato solo para aprender, medir o validar? | Define si se usará SBC compacto, compute module con carrier comercial o eventualmente otra ruta. |
| Proveedores | ¿Dónde puedo conseguir las piezas: local, AliExpress, Amazon, MercadoLibre, tiendas electrónicas, reciclaje? | Permite validar experiencia visual, resolución, relación de aspecto, consumo e integración. |
| Tiempo de entrega | ¿Qué componentes debo pedir primero porque pueden demorar más? | Permite probar OS, frontend y juegos sin esperar controles finales. |
| Costo oculto | ¿Qué gastos puedo estar subestimando: envíos, impuestos, cables, conectores, tornillos, herramientas, baterías? | Permite encender y probar el sistema de forma segura. |
| Fase | Pregunta guía | Evita que los componentes lleguen y no se puedan usar, flashear, medir o conectar. |
| Concepto | ¿Qué quiero que sea esta consola y qué la hace interesante? | Descripción |
| V0 | ¿Cuál es la prueba mínima funcional? | Componentes que definen arquitectura y tienen tiempos largos de entrega. |
| V1 | ¿Qué la convierte en una consola portable real? | Componentes útiles, pero no indispensables para las primeras pruebas. |
| V1.5 | ¿Qué refinamientos mejoran ergonomía, autonomía, estabilidad y acabado? | Herramientas, cables, adaptadores y consumibles que se pueden conseguir rápido. |
| V2 | ¿Qué tendría que cambiar para que sea más limpia, modular, replicable o cercana a producto? | Elementos de acabado, ergonomía o refinamiento que pueden esperar. |
| Futuro | ¿Qué aprendizajes de esta consola pueden alimentar otros proyectos de Handheld Lab? | Trabajo durante la espera |
| Fecha | Decisión | Limpiar el documento, numeración, decisiones cerradas, bitácora y objetivos por versión. |
|  |  | Investigar OS compatibles con la plataforma elegida, métodos de instalación, imágenes, flasheo y recuperación. |
| Riesgo | Por qué importa | Diseñar los protocolos de prueba para boot, pantalla, input, audio, consumo, temperatura y pick-up-and-play. |
|  |  | Verificar que se tienen cables, adaptadores, lector microSD, fuente, multímetro, soldadura, conectores y consumibles. |
|  |  | Bocetar form factor, layout de controles, ubicación tentativa de pantalla, batería, cerebro y PCBs hijas. |
|  |  | Investigar switches, membranas, joysticks, botones, layout y posibles microcontroladores HID. |
| Prioridad | Acción | Investigar power path, cargadores, protección de batería, boost/buck converters y medición de consumo. |
| Alta |  | Definir niveles posibles de cartridge: microSD físico, EEPROM, NFC, USB, perfil o modo. |
| Media |  | Construir lista de materiales con precios, proveedores, tiempos de entrega y riesgos. |
| Baja |  | Diseñar PCBs simples no críticas como ejercicio: botones, breakout, LEDs o adaptadores. |
